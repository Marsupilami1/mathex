...
/* package mathex-0.1.0.0 */
#ifndef VERSION_mathex
#define VERSION_mathex "0.1.0.0"
#endif /* VERSION_mathex */
#ifndef MIN_VERSION_mathex
#define MIN_VERSION_mathex(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_mathex */
...
#define CURRENT_COMPONENT_ID "mathex-0.1.0.0-inplace-mathex"
